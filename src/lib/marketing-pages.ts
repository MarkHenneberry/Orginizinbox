...
export const marketingPages: MarketingPage[] = [
  ...
  },
  {
    ...
    description: "A practical Outlook.com and Hotmail cleanup guide: review recurring senders, use Deleted Items carefully, and understand Organizinbox availability and recovery limits.",
    h1: "Outlook cleaner that shows the clutter first.",
    eyebrow: "Outlook",
    body: "Find recurring senders and old mail before clearing an Outlook.com or Hotmail inbox. This guide separates steps you can take in Outlook today from Organizinbox features that are not yet available for production cleanup.",
  ...
  },
  {
    ...
    title: "Delete Gmail Emails by Sender: Search and Review",
    description: "Find Gmail messages from one sender, narrow by age, review conversations, and move unwanted mail to Trash. Learn what sender-based selection can miss.",
  ...
  },
  {
    ...
    title: "Delete Old Gmail Emails: Date Search and Safe Review",
    description: "Use Gmail date searches to find old email, review what matters, and move selected messages to Trash. Understand age limits, storage, and recovery before deleting.",
    h1: "Delete old Gmail emails.",
    eyebrow: "Old mail",
    body: "An old message is not necessarily unwanted. Start with a date search, then review senders and conversations before selecting mail. Organizinbox also considers protection and bulk-mail evidence, not age alone.",
