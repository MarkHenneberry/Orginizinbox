...
export const marketingPages: MarketingPage[] = [
  {
    slug: "gmail-cleaner",
    title: "Gmail Cleaner: Find Senders and Old Email Clutter",
    description: "See which senders fill your Gmail inbox. Learn how to review old email, protect important messages, and understand Trash, privacy, and Undo limits.",
  ...
  },
  {
    ...
    title: "Outlook and Hotmail Cleaner: Review Inbox Clutter",
    description: "Scan your Outlook.com or Hotmail inbox with Organizinbox, review your Inbox Report, and choose what to clean. See availability, protection and Undo limits.",
    h1: "Outlook cleaner that shows the clutter first.",
    eyebrow: "Outlook",
    body: "Organizinbox scans your Outlook.com or Hotmail inbox first. Your Inbox Report shows which senders create the clutter. You then choose what to clean, where cleanup is available.",
  ...
  },
  {
    slug: "pricing",
    title: "Pricing",
    description: "Free inbox reports. Buy 10,000, 50,000 or 100,000 cleanup credits for $10, $15 or $20 USD. No subscription. Credits never expire.",
    h1: "One-time cleanup credits",
    eyebrow: "Pricing",
    body: "Start with a free Inbox Scan. See the senders and old email filling your inbox before you decide what to clean.",
    bullets: ["Free Inbox Report", "No subscription or recurring charge", "Pay only for verified moves"],
    cta: "Clean my inbox",
  ...
  },
  {
    ...
    eyebrow: "Security",
    body: "Saved connection credentials and temporary reports are encrypted. Cleanup requires your confirmation. Disconnect destroys Organizinbox's saved access and temporary report and restoration state for that provider. Undo is then unavailable, even if you reconnect. Removing Google Account authorization is a separate action.",
  ...
  },
  {
    ...
    bullets: ["Temporary encrypted reports, not a permanent inbox copy", "No mailbox data sent to third-party analytics", "Subject lines are used for protection, then discarded"],
    cta: "Clean my inbox",
    providerIntent: "generic",
    contentCluster: "trust",
  ...
  },
  {
    ...
    title: "Delete Gmail Emails by Sender: Scan and Review",
    description: "Scan your Gmail inbox with Organizinbox, review suggested messages by sender, and choose what to move to Trash. Protected messages stay out of cleanup.",
    h1: "Delete Gmail emails by sender.",
    eyebrow: "Sender cleanup",
    body: "Scan your whole Gmail inbox first. Organizinbox shows which senders create the clutter, so you can review suggested messages and choose what to clean. You do not need to pick a sender before scanning.",
  ...
  },
  {
    ...
    title: "Delete Old Gmail Emails: Scan and Review Before Cleanup",
    description: "Find old Gmail clutter with an Organizinbox scan. Review your Inbox Report before choosing what to move to Trash. Understand protection, storage and Undo limits.",
    h1: "Delete old Gmail emails.",
    eyebrow: "Old mail",
    body: "Scan your whole Gmail inbox first. Your Inbox Report shows old mail and suggested sender groups to review. You do not need to choose a date range before scanning, and old messages are not automatically suggested for cleanup.",
